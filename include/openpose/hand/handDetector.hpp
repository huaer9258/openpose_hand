...
namespace op
{
    ...
    public:
        ...
        std::vector<std::array<Rectangle<float>, 2>> detectHands(const cv::Mat& cvInputData, const float scaleInputToOutput) const;

        std::vector<std::array<Rectangle<float>, 2>> trackHands(const cv::Mat& cvInputData, const float scaleInputToOutput);
